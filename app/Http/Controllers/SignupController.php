...
class SignupController extends Controller
{
    ...
    public function create(Request $request, ZeptoMailService $zeptomail)
    {
        ...
        $validatedData = $request->validate([
            ...
            'class_division' => 'nullable|string|max:100',
        ...
        $mergeData = [
            ...
            'platform_url' => 'https://exam.schooldrive.com.ng', // NEW
        ];
    
        try {
    
            // --- 1. Notify the NEWLY REGISTERED USER (Welcome email)
            Http::withoutVerifying()
                ...
                ->post(env('ZEPTOMAIL_URL') . '/v1.1/email/template', [
                    'template_key' => 'user-welcome-onboard',     // NEW TEMPLATE
                    'from' => [
                        'address' => 'support@schooldrive.com.ng',
                        'name'    => 'SchoolDrive'
                    ],
                    'to' => [
                        ['email_address' => ['address' => $user->email]]  // SEND TO USER
                    ],

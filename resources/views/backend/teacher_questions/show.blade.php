...
@section('title', 'View Curriculum Questions')
    ...
    <div class="content">
        ...
        <div class="module">
            ...
            <div class="module-body">
                ...
                @else
                    <p class="text-warning">No questions available for this curriculum.</p>
                @endif

                <a href="{{ route('teacher.ai_questions') }}" class="btn btn-secondary mt-3">Back</a>
            </div>
        </div>
    </div>
</div>
